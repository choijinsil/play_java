...
public class MMainView extends JFrame {
	...
	public MMainView() {
		...
		pNumBtn_1.setIcon(new ImageIcon("src/image/pNum/수정됨_제품번호1.png"));
		...
		pNumBtn_2.setIcon(new ImageIcon("src/image/pNum/수정됨_제품번호2.png"));
		...
		pNumBtn_3.setIcon(new ImageIcon("src/image/pNum/수정됨_제품번호3.png"));
		...
		pNumBtn_4.setIcon(new ImageIcon("src/image/pNum/수정됨_제품번호4.png"));
		...
		pNumBtn_5.setIcon(new ImageIcon("src/image/pNum/수정됨_제품번호5.png"));
		...
		pNumBtn_6.setIcon(new ImageIcon("src/image/pNum/수정됨_제품번호6.png"));
		...
		pNumBtn_7.setIcon(new ImageIcon("src/image/pNum/수정됨_제품번호7.png"));
		...
		pNumBtn_8.setIcon(new ImageIcon("src/image/pNum/수정됨_제품번호8.png"));
		...
		keyDisplayArea.setFont(new Font("고딕", Font.BOLD,30));
		keyDisplayArea.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
		//keyDisplayArea.setText("입력창"); // 입력창
		keyDisplayArea.setBounds(480, 146, 76, 53);
		...
		keypadBtn_1.setIcon(new ImageIcon("src/image/button/버튼1.png"));
		...
		keypadBtn_2.setIcon(new ImageIcon("src/image/button/버튼2.png"));
		...
		keypadBtn_3.setIcon(new ImageIcon("src/image/button/버튼3.png"));
		...
		keypadBtn_4.setIcon(new ImageIcon("src/image/button/버튼4.png"));
		...
		keypadBtn_5.setIcon(new ImageIcon("src/image/button/버튼5.png"));
		...
		keypadBtn_6.setIcon(new ImageIcon("src/image/button/버튼6.png"));
		...
		keypadBtn_7.setIcon(new ImageIcon("src/image/button/버튼7.png"));
		...
		keypadBtn_8.setIcon(new ImageIcon("src/image/button/버튼8.png"));
		...
		keypadBtn_9.setIcon(new ImageIcon("src/image/button/버튼9.png"));
		...
		keypadBtn_OK.setIcon(new ImageIcon("src/image/확인.png"));
...
//		saleLabel.setIcon(new ImageIcon("src/image/\uD310\uB9E4\uAC00\uB2A5.png"));
...
//		contentPane.add(saleLabel);
		...
		// 판매가능,불가능 디스플레이 창
		saleOkLabel = new JLabel(new ImageIcon("src/image/판매가능.png"));
		saleOkLabel.setIcon(new ImageIcon("src/image/판매가능.png"));
		...
		saleNoLabel = new JLabel(new ImageIcon("src/image/판매불가.png"));
		saleNoLabel.setIcon(new ImageIcon("src/image/판매불가.png"));
		saleNoLabel.setForeground(Color.DARK_GRAY);
		saleNoLabel.setBackground(Color.DARK_GRAY);
		saleNoLabel.setBounds(460, 460, 170, 50);
		contentPane.add(saleNoLabel);
		
		// 금액 디스플레이 창
		moneyDisplayArea = new JTextArea();
		moneyDisplayArea.setFont(new Font("고딕", Font.BOLD,30));
		moneyDisplayArea.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
		//moneyDisplayArea.setText("금액 디스플레이 창");
		moneyDisplayArea.setBounds(483, 530, 135, 53);
		...
		moneyInputBtn.setIcon(new ImageIcon("src/image/돈투입.png"));
		moneyInputBtn.setBounds(463, 594, 178, 49);
		...
		adminBtn.setIcon(new ImageIcon("src/image/관리자모드.png"));
		adminBtn.setBounds(463, 647, 50, 122);
		...
		returnBtn.setIcon(new ImageIcon("src/image/잔돈반환.png"));
		returnBtn.setBounds(519, 646, 121, 122);
		...
		// 제품출구
		  ...
		  outLabel.setIcon(new ImageIcon("src/image/제품출구.png"));
		...
		//선택한 제품
		label_4 = new JLabel("");
		label_4.setIcon(new ImageIcon("src/image/선택한제품.png"));
		label_4.setBounds(467, 126, 170, 84);
		contentPane.add(label_4);
		
		//투입한 금액
		label_5 = new JLabel("");
		label_5.setIcon(new ImageIcon("src/image/투입한금액.png"));
		label_5.setBounds(452, 515, 200, 80);
		...
		lblPaneimg.setIcon(new ImageIcon("src/image/mainPane.png"));
