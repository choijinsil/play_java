...
public class JCheckBoxTest extends JFrame {
   ...
   public JCheckBoxTest() {
	 ...
	 cb1 = new JCheckBox("첫번째체크박스", icon1);   
	   cb1.setRolloverIcon(icon2);//체크박스 위에 마우스가 올려졌을때
	   cb1.setSelectedIcon(icon3);//체크박스가 선택되었을때
	 ...
	 panel.setBorder(new TitledBorder(new BevelBorder(BevelBorder.RAISED) , "패널타이틀") );  
